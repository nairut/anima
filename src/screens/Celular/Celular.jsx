      ...
      >
        {screenWidth < 1000 && (
          <>
            ...
            <Link className="click-to-discover-wrapper" to="/z">
        ...
        {screenWidth >= 1000 && screenWidth < 1300 && (
          <>
            ...
            <div className="overlap-2">
              ...
              <img className="img" alt="Next" src="/img/next-1.png" />
            </div>
            <div className="overlap-3">
              <div className="text-wrapper-4">Medical</div>
              <img className="img" alt="Medical bag" src="/img/medical-bag-1.png" />
            </div>
            <div className="overlap-4">
              <div className="text-wrapper-5">E-Learning</div>
              <img className="img" alt="Mba" src="/img/mba-1.png" />
            </div>
            <div className="overlap-5">
              <div className="text-wrapper-6">Manufacturing</div>
              <img className="img" alt="Manufacturing" src="/img/manufacturing-1.png" />
            </div>
            <div className="overlap-6">
              <div className="text-wrapper-7">Automotive</div>
              <img className="img" alt="Tesla model x" src="/img/tesla-model-x-1.png" />
            </div>
            ...
            <div className="overlap-group-2">
              ...
              <img className="img" alt="Commercial" src="/img/commercial-1.png" />
            </div>
            <div className="overlap-8">
              <div className="text-wrapper-6">IT &amp; Software</div>
              <img className="img" alt="Programming flag" src="/img/programming-flag-1.png" />
            </div>
            <div className="overlap-9">
              <div className="text-wrapper-10">Life Science</div>
              <img className="img" alt="Biotech" src="/img/biotech-2.png" />
            </div>
            <div className="overlap-10">
              <div className="text-wrapper-8">Tourism</div>
              <img className="img" alt="Plane" src="/img/plane-1.png" />
            </div>
            <div className="overlap-11">
              <div className="text-wrapper-11">E-commerce</div>
              <img className="img" alt="Buy" src="/img/buy-1.png" />
            </div>
            ...
            <div className="overlap-12">
              ...
              <img className="img-2" alt="Pdf" src="/img/pdf-1.png" />
            </div>
            ...
            <div className="overlap-14">
              ...
              <img className="img-2" alt="Website" src="/img/website-1.png" />
            </div>
            <div className="overlap-15">
              <div className="text-wrapper-14">Video Subtitling</div>
              <img className="img-2" alt="Video camera" src="/img/video-camera-1.png" />
            </div>
            <div className="overlap-16">
              <div className="text-wrapper-15">Product Descriptions</div>
              <img className="img-2" alt="E commerce" src="/img/e-commerce-1.png" />
            </div>
        ...
        {screenWidth >= 1000 && screenWidth < 1300 && (
          <>
            <img className="star-2" alt="Star" src="/img/star-22-1.png" />
            <img className="star-3" alt="Star" src="/img/star-27-1.png" />
            <img className="star-4" alt="Star" src="/img/star-18-1.png" />
            <img className="star-5" alt="Star" src="/img/star-23-1.png" />
            <img className="star-6" alt="Star" src="/img/star-28-1.png" />
            <img className="star-7" alt="Star" src="/img/star-19-1.png" />
            <img className="star-8" alt="Star" src="/img/star-24-1.png" />
            <img className="star-9" alt="Star" src="/img/star-29-1.png" />
            <img className="star-10" alt="Star" src="/img/star-20-1.png" />
            <img className="star-11" alt="Star" src="/img/star-25-1.png" />
            <img className="star-12" alt="Star" src="/img/star-30-1.png" />
            <img className="magma-translation" alt="Magma translation" src="/img/magma-translation-png-2.png" />
            <div className="frame">
        ...
        {screenWidth >= 1300 && (
          <>
            ...
            <div className="group-4">
              ...
              <Group className="group-5" property1="default" talkToAnExpertClassName="group-6" to="/z" />
            </div>
