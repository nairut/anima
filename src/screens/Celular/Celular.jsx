  ...
  return (
    <div className="celular">
      <div
        className="div-2"
        style={{
          border: screenWidth < 1300 ? "1px none" : screenWidth >= 1300 ? "0.99px none" : undefined,
          height: screenWidth < 1300 ? "912px" : screenWidth >= 1300 ? "3647px" : undefined,
      ...
      >
        ...
        <img
          ...
          style={{
            height: screenWidth < 1300 ? "54px" : screenWidth >= 1300 ? "70px" : undefined,
            left: screenWidth < 1300 ? "118px" : screenWidth >= 1300 ? "151px" : undefined,
            top: screenWidth < 1300 ? "34px" : screenWidth >= 1300 ? "837px" : undefined,
            width: screenWidth < 1300 ? "194px" : screenWidth >= 1300 ? "101px" : undefined,
          }}
        ...
        {screenWidth >= 1300 && (
          <>
            ...
            <img className="rectangle-5" alt="Rectangle" src="/img/rectangle-14.png" />
            <img className="rectangle-6" alt="Rectangle" src="/img/rectangle-7.png" />
            <img className="rectangle-7" alt="Rectangle" src="/img/rectangle-15.png" />
            <img className="rectangle-8" alt="Rectangle" src="/img/rectangle-8.png" />
            <img className="evoltz-png" alt="Evoltz png" src="/img/evoltz-png-0.png" />
            <img className="rectangle-9" alt="Rectangle" src="/img/rectangle-9.png" />
            <img className="jungheinrich-png" alt="Jungheinrich png" src="/img/jungheinrich-png-0.png" />
            <img className="rectangle-10" alt="Rectangle" src="/img/rectangle-10.png" />
