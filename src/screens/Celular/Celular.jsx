    ...
    <div className="celular">
      ...
      >
        ...
        {((screenWidth >= 1201 && screenWidth < 1300) ||
          ...
          <>
            <Group
              className={`${screenWidth >= 1400 && screenWidth < 1500 && "class-15"} ${
                screenWidth >= 1201 && screenWidth < 1300 && "class-16"
              } ${screenWidth >= 1300 && screenWidth < 1400 && "class-17"} ${screenWidth >= 1500 && "class-18"}`}
              property1="default"
              talkToAnExpertClassName="group-2-instance"
              to="/desktop-form"
            />
            <Group
              className={`${screenWidth >= 1400 && screenWidth < 1500 && "class-19"} ${
                screenWidth >= 1201 && screenWidth < 1300 && "class-20"
              } ${screenWidth >= 1300 && screenWidth < 1400 && "class-21"} ${screenWidth >= 1500 && "class-22"}`}
              property1="default"
              talkToAnExpertClassName="group-2-instance"
              to="/desktop-form"
            />
        ...
        {((screenWidth >= 1201 && screenWidth < 1300) ||
          ...
          <img
            ...
            alt="Magma translation"
            src="/img/magma-translation-png-3.png"
          />
        )}
