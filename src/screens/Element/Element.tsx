        ...
        >
          {((screenWidth >= 430 && screenWidth < 1200) || screenWidth < 430) && (
            <img
              className="vector"
              style={{
                height: screenWidth < 430 ? "182px" : screenWidth >= 430 && screenWidth < 1200 ? "311px" : undefined,
                left: screenWidth < 430 ? "13px" : screenWidth >= 430 && screenWidth < 1200 ? "24px" : undefined,
                width: screenWidth < 430 ? "122px" : screenWidth >= 430 && screenWidth < 1200 ? "208px" : undefined,
              }}
              alt="Vector"
              src={
                screenWidth < 430
