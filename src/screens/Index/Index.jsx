...
import { Star13 } from "../../icons/Star13";
import { Star14 } from "../../icons/Star14";
import { Star15 } from "../../icons/Star15";
  ...
  return (
    <div className="index">
      <div className="div">
        ...
        <Star6 className="star-6" />
        <Star11 className="star-11" />
        <Star2 className="star-2" />
        <Star7 className="star-7" />
        <Star12 className="star-12" />
        <Star3 className="star-3" />
        <Star8 className="star-8" />
        <Star13 className="star-13" />
        <Star4 className="star-4" />
        <Star9 className="star-9" />
        <Star14 className="star-14" />
